...
export const EquityCurveChart: React.FC<Props> = React.memo(({ data, currency, numberFormat }) => {
  ...
  const handleViewModeDates = React.useCallback(() => setViewMode('dates'), []);
  const handleViewModeTrades = React.useCallback(() => setViewMode('trades'), []);
