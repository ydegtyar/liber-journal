...
export const GithubActivityCalendar: React.FC<Props> = React.memo(
  ({ trades, currency, numberFormat }) => {
    ...
    const getCellColor = useCallback(
      (stats: DailyStats | undefined, inYear: boolean) => {
        if (!inYear) {
          return 'transparent';
        }
        ...
        >
          <Chip
            ...
            label={`${yearStats.totalTradingDays} ${t('calendar.activeDays')}: ${yearStats.winDays}W / ${yearStats.lossDays}L (${
              yearStats.totalTradingDays > 0
                ? Math.round((yearStats.winDays / yearStats.totalTradingDays) * 100)
                : 0
            }%)`}
            size="small"
            variant="outlined"
                        ...
                        <Box sx={{ p: 0.5 }}>
                          ...
                          <Typography
                            ...
                            sx={{
                              fontWeight: 800,
                              color:
                                stats.pnl > 0 ? '#4ade80' : stats.pnl < 0 ? '#f87171' : 'inherit',
                              display: 'block',
                              fontSize: '0.8rem',
                            }}
                          >
                          ...
                          >
                            {stats.tradesCount} {t('calendar.trades')} ({stats.wins}W /{' '}
                            {stats.losses}L / {stats.breakeven}BE)
                          </Typography>
                          <Typography
                            variant="caption"
                            sx={{ color: 'text.secondary', display: 'block' }}
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            ...
            <Box
              sx={{
                ...
                height: 10,
                borderRadius: '2px',
                backgroundColor: isDark ? '#ef4444' : '#b71c1c',
              }}
            />
            <Box
              sx={{
                ...
                height: 10,
                borderRadius: '2px',
                backgroundColor: isDark ? '#b91c1c' : '#e53935',
              }}
            />
            <Box
              sx={{
                ...
                height: 10,
                borderRadius: '2px',
                backgroundColor: isDark ? '#7f1d1d' : '#ef9a9a',
              }}
            />
            <Box
              sx={{
                ...
                height: 10,
                borderRadius: '2px',
                backgroundColor: isDark ? '#4c1d24' : '#ffcdd2',
              }}
            />
          </Box>
...
GithubActivityCalendar.displayName = 'GithubActivityCalendar';
